      ...
      <section id="home" className="pt-32 pb-20 relative overflow-hidden">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
                ...
                <div className="absolute bottom-0 right-10 w-[400px] h-[500px] bg-gradient-to-tr from-blue-100 to-blue-50 rounded-t-full -z-10" />
                <div className="absolute bottom-10 right-0 w-[380px] h-[480px] border-2 border-slate-900 rounded-t-full -z-10 translate-x-4 translate-y-4" />
                <div className="absolute bottom-20 right-20 w-32 h-32 bg-yellow-200 rounded-full blur-2xl opacity-60 -z-10" />
