...
const App = () => {
  ...
  const handleMouseEnter = () => document.getElementById("cursor").classList.add("hovered");
  const handleMouseLeave = () => document.getElementById("cursor").classList.remove("hovered");
