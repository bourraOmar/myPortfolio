  ...
  return (
    <div className="portfolio-root">
      ...
      <div className="fixed-bg">
        <div className="glow-radial" style={{ top: '-10%', left: '-10%', width: '60%', height: '60%', opacity: 0.15, filter: 'blur(100px)', '--glow-color': 'var(--accent)' } as any}></div>
        <div className="glow-radial" style={{ bottom: '-20%', right: '-10%', width: '70%', height: '70%', opacity: 0.1, filter: 'blur(120px)', '--glow-color': 'var(--violet)' } as any}></div>
        <div className="glow-radial" style={{ top: '30%', right: '10%', width: '40%', height: '40%', opacity: 0.05, filter: 'blur(80px)', '--glow-color': 'var(--gold)' } as any}></div>
      </div>
      ...
      <footer id="contact" className="footer container">
        <div className="glow-radial" style={{ top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '100%', height: '100%', opacity: 0.05, filter: 'blur(120px)', '--glow-color': 'var(--violet)' } as any}></div>
        ...
        <div className="footer-btns">
          ...
          <a href={PERSONAL_INFO.linkedin} target="_blank" rel="noopener noreferrer" className="btn-secondary glass-card" style={{ '--hover-bg': 'var(--accent)' } as any}>
